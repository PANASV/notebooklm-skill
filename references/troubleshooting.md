...
cp ~/.codex/skills/notebooklm/data/library.json library.backup.json

# Reset library
rm ~/.codex/skills/notebooklm/data/library.json
...
```bash
# Check disk usage
df -h ~/.codex/skills/notebooklm/data/
...
if [ -f ~/.codex/skills/notebooklm/data/library.json ]; then
    cp ~/.codex/skills/notebooklm/data/library.json ~/library.backup.json
fi
...
if [ -f ~/library.backup.json ]; then
    mkdir -p ~/.codex/skills/notebooklm/data/
    cp ~/library.backup.json ~/.codex/skills/notebooklm/data/library.json
fi
```
...
ls -la ~/.codex/skills/notebooklm/data/
```
